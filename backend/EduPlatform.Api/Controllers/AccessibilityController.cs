...
public class AccessibilityController : ControllerBase
{
    ...
    public async Task<IActionResult> GetCategories() =>
        Ok(await _db.AccessibilityCategories.AsNoTracking().Select(c => new AccessibilityCategoryDto { Id = c.Id, Name = c.Name, Description = c.Description }).ToListAsync());
    ...
    // POST /api/accessibility/categories/{id}/topics { topicId: number }
